...
let zombies = copyInputData.zombie;
let creatures = copyInputData.creatures;
const commands = copyInputData.commands.split("");
const boardSize = copyInputData.gridSize;
const allZombies = [];
